...
function fNumber$1(ctx, targetNumber, bits, unsigned, endian) {
    check_size$1(ctx, Math.floor(bits / 8), 0);
...
class BiBaseStreamer {
    ...
    open() {
        ...
        if (buff__namespace == undefined || fs == undefined) {
