...
class biwriter {
    ...
    */
    lShift(shiftKey, startOffset, endOffset, consume) {
        ...
        return (0, common_1.LSHIFT)(this, lShiftKey, startOffset || this.offset, endOffset || this.size, consume || false);
    }
    /**
    * Left shift data
    *
    ...
    */
    lShiftThis(shiftKey, length, consume) {
        ...
        return (0, common_1.LSHIFT)(this, shiftKey, this.offset, this.offset + Length, consume || false);
    }
    /**
    * Right shift data
    *
    ...
    */
    rShift(shiftKey, startOffset, endOffset, consume) {
        ...
        return (0, common_1.RSHIFT)(this, rShiftKey, startOffset || this.offset, endOffset || this.size, consume || false);
    }
    /**
    * Right shift data
    *
    ...
    */
    rShiftThis(shiftKey, length, consume) {
        ...
        return (0, common_1.RSHIFT)(this, lShiftKey, this.offset, this.offset + Length, consume || false);
    }
    /**
    * Add value to data
    *
    ...
    */
    add(addKey, startOffset, endOffset, consume) {
        ...
        return (0, common_1.ADD)(this, addedKey, startOffset || this.offset, endOffset || this.size, consume || false);
    }
    /**
    * Add value to data
    *
    ...
    */
    addThis(addKey, length, consume) {
        ...
        return (0, common_1.ADD)(this, AddedKey, this.offset, this.offset + Length, consume || false);
    }
    //
    //remove part of data
    //
    ...
    */
    clip() {
        return (0, common_1.remove)(this, this.offset, this.size, false, true);
    }
    /**
    * Deletes part of data from current byte position to end, returns removed
    * Note: Errors in strict mode
    ...
    */
    extract(length, consume) {
        return (0, common_1.remove)(this, this.offset, this.offset + (length || 0), consume || false, false);
    }
    /**
    * Extract data from current position to length supplied
    * Note: Does not affect supplied data
